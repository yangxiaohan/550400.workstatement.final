...
After finishing building this simplest linear model, I will check how the model performs to predict the dependent variable according to some criteria. If it performs well, it may be a good time to stop. But if not, I will consider about some other complex forms of the regression model to see how they work. For example, I may consider the form that includes the cross term:
\begin{align*}
Premolt~Size = ~&\beta_0 + \beta_1 (Postmolt~Size) + \beta_2 (Type~of~Data)\\
